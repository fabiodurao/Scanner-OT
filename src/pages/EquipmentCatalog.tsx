...
const EquipmentCatalogPage = () => {
  ...
  const { manufacturers: refManufacturers, models: refModels } = useCatalogEntities();
  ...
  const totalManufacturers = refManufacturers.length;
  const totalModels = refModels.length;
