...
const VariablesReviewGlobal = () => {
  ...
  const loadVariables = useCallback(async () => {
    ...
    if (selectedSiteId !== 'all') {
      query = query.eq('site_identifier', selectedSiteId);
    }
  ...
  const counts = {
    ...
    withHistory: variables.filter(v => v.winner !== null).length,
          ...
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <p className="text-muted-foreground mt-1">
                Review and confirm AI suggestions across all sites
              </p>
            </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5 mb-6">
          <Card>
            ...
            <CardContent>
              ...
              {selectedSiteId !== 'all' && (
                <p className="text-xs text-muted-foreground mt-1">in selected site</p>
              )}
            </CardContent>
          </Card>
          ...
          <Card className="mb-6 border-purple-200 bg-purple-50/30">
            <CardHeader>
              ...
              <CardDescription className="text-purple-700">
                {bySite.length} site{bySite.length !== 1 ? 's have' : ' has'} variables with AI suggestions pending review
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
                {bySite.slice(0, 6).map(site => (
                  <button
                    ...
                    onClick={() => handleSiteChange(site.siteIdentifier)}
                    ...
                    <div className="flex items-center gap-3 min-w-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <div className="text-xs text-muted-foreground">
                          {site.count} variable{site.count !== 1 ? 's' : ''}
                        </div>
                      </div>
                    </div>
              ...
              {bySite.length > 6 && (
                <p className="text-xs text-purple-700 mt-3 text-center">
                  +{bySite.length - 6} more sites with pending reviews
                </p>
              )}
            </CardContent>
          </Card>
              ...
              <div className="space-y-2">
                ...
                <Select value={aiFilter} onValueChange={setAiFilter}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="no_ai">
                      Without AI ({counts.all - counts.withAi})
                    </SelectItem>
                  </SelectContent>
                </Select>
              </div>
            ...
            <CardContent className="py-12 text-center text-muted-foreground">
              {hasActiveFilters ? (
                ...
                <>
                  ...
                  <p className="text-sm">No variables need review at the moment.</p>
                </>
              ) : (
                <>
