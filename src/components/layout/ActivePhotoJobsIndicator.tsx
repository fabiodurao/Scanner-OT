...
export const ActivePhotoJobsIndicator = () => {
  const { activeJobs, loading } = usePhotoAnalysisJobs();
        ...
        <div className="flex items-center justify-between px-2 py-1.5 mb-1">
          <div className="flex items-center gap-2">
            <div className="relative">
              ...
              <span className="absolute -top-1 -right-1 h-2 w-2 bg-pink-400 rounded-full animate-pulse" />
            </div>
            <span className="text-xs font-medium text-pink-400">
              Photo Analysis Running
            </span>
          </div>
        </div>
          ...
          {activeJobs.slice(0, 2).map(job => (
            ...
            >
              <div className="flex items-center gap-2 mb-1.5">
                <div className="flex items-center justify-center w-5 h-5 rounded bg-pink-500/20">
