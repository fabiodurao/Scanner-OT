  ...
  return (
    <div className="rounded-lg border overflow-hidden">
      ...
      <div className="grid grid-cols-12 gap-4 px-4 py-2 bg-slate-50 border-b text-xs font-medium text-muted-foreground uppercase tracking-wide">
        ...
        <div className="col-span-2 text-center">Equipment</div>
        <div className="col-span-2 text-center">Variables</div>
                ...
                {loadingStats ? (
                  ...
                  <div className="flex flex-col items-center gap-1">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="font-semibold text-sm text-emerald-600">{confirmed}</span>
                    </div>
